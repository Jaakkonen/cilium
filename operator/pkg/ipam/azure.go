...
func (cfg AzureConfig) Flags(flags *pflag.FlagSet) {
	...
	flags.String(operatorOption.AzureResourceGroup, azureDefaultConfig.AzureResourceGroup, "Resource group containing the cluster nodes (defaults to the operator's own resource group via Azure IMS)")
